<#
.SYNOPSIS
    PsMediaFinder - A PowerShell-based audio, video, and picture file finder.
...
.EXAMPLE
    .\PsMediaFinder.ps1 -Path "C:\Users\Documents" -MediaType Audio
    Searches for audio files only in the specified directory.

.EXAMPLE
    .\PsMediaFinder.ps1 -Path "D:\Media" -Recursive $false
    Searches for media files only in the specified directory (no subdirectories).

.EXAMPLE
    .\PsMediaFinder.ps1 -Path "C:\Media" -ExportCSV "media_results.csv" -ShowDetails
